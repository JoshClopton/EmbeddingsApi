namespace EmbeddingsApi2
{
    public record PreloadRequest(
        ...
        string? VocabularyPath      /* file path where the vocabulary file for the model is located. 
                                    This file typically contains a mapping of words or tokens to 
                                    their corresponding IDs, which is essential for processing and 
                                    tokenizing text inputs in natural language processing (NLP) models.*/
    );
}
